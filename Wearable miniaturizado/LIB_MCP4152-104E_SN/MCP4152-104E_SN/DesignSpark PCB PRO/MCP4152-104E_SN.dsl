...
(library Library_1
	...
	(compDef "MCP4152-104E_SN" (originalName "MCP4152-104E_SN") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "7" (pinName "SDO") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "P0B") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "P0W") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://ww1.microchip.com/downloads/en/DeviceDoc/22060b.pdf")
		(attr "Height" "1.75 mm")
	)
