...
//159159/351150/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "MCP4152-104E_SN" (originalName "MCP4152-104E_SN")
	...
	(compDef "MCP4152-104E_SN" (originalName "MCP4152-104E_SN") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "7" (pinName "SDO") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "P0B") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "P0W") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MCP4152-104E_SN"))
		...
		(attr "Mouser Part Number" "579-MCP4152-104E/SN")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Microchip-Technology/MCP4152-104E-SN?qs=hH%252BOa0VZEiB7bI70qkcaWA%3D%3D")
		(attr "Manufacturer_Name" "Microchip")
		(attr "Manufacturer_Part_Number" "MCP4152-104E/SN")
		(attr "Description" "Digital Potentiometer 256 Step 100kOhm")
		(attr "<Hyperlink>" "http://ww1.microchip.com/downloads/en/DeviceDoc/22060b.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "MCP4152-104E_SN.stp")
