...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_RX_SEG_MAX, 10);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_CHAT_CLI_MESSAGE_LENGTH, 90);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_CHAT_SAMPLE_PRESENCE_CACHE_SIZE, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_CHAT_CLI_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_CHAT_CLI_LOG_LEVEL, 3);
